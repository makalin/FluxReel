...
fn overlay(base: (f32, f32, f32), blend: (f32, f32, f32)) -> (f32, f32, f32) {
    (
        if base.0 < 0.5 {
            ...
            1.0 - 2.0 * (1.0 - base.0) * (1.0 - blend.0)
        },
        if base.1 < 0.5 {
            2.0 * base.1 * blend.1
        } else {
            1.0 - 2.0 * (1.0 - base.1) * (1.0 - blend.1)
        },
        if base.2 < 0.5 {
            2.0 * base.2 * blend.2
        } else {
            1.0 - 2.0 * (1.0 - base.2) * (1.0 - blend.2)
        },
    )
}
...
fn color_dodge(base: (f32, f32, f32), blend: (f32, f32, f32)) -> (f32, f32, f32) {
    (
        if blend.0 == 1.0 {
            ...
            (base.0 / (1.0 - blend.0)).min(1.0)
        },
        if blend.1 == 1.0 {
            1.0
        } else {
            (base.1 / (1.0 - blend.1)).min(1.0)
        },
        if blend.2 == 1.0 {
            1.0
        } else {
            (base.2 / (1.0 - blend.2)).min(1.0)
        },
    )
}
...
fn color_burn(base: (f32, f32, f32), blend: (f32, f32, f32)) -> (f32, f32, f32) {
    (
        if blend.0 == 0.0 {
            ...
            (1.0 - (1.0 - base.0) / blend.0).max(0.0)
        },
        if blend.1 == 0.0 {
            0.0
        } else {
            (1.0 - (1.0 - base.1) / blend.1).max(0.0)
        },
        if blend.2 == 0.0 {
            0.0
        } else {
            (1.0 - (1.0 - base.2) / blend.2).max(0.0)
        },
    )
}
...
fn subtract(base: (f32, f32, f32), blend: (f32, f32, f32)) -> (f32, f32, f32) {
    (
        (base.0 - blend.0).max(0.0),
        (base.1 - blend.1).max(0.0),
        (base.2 - blend.2).max(0.0),
    )
}
